...
2. Run `dotnet new --install Net.WebApi.Template::1.0.0-rc.5` to install the project template

```
C:\> dotnet new install Net.WebApi.Template::1.0.0-rc.5
The following template packages will be installed:
   Net.WebApi.Template::1.0.0-rc.5

Success: Net.WebApi.Template::1.0.0-rc.5 installed the following templates:
...
After installing .NET Web API Solution Template(Net.WebApi.Template::1.0.0-rc.5) 
