    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCatergories", x => x.CategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductCatergoryCategoryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.ProductID);
                    table.ForeignKey(
                        name: "FK_Products_ProductCatergories_ProductCatergoryCategoryId",
                        column: x => x.ProductCatergoryCategoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductCatergoryCategoryId",
                table: "Products",
                column: "ProductCatergoryCategoryId");
